...
\end{align}
But if $D\ge d$ and $\Fmat'\Wmat\Fmat$ is invertible, we can conveniently rearrange this into a t-distribution for $\zvec$. To do this, (dropping subscripts for now) we define: 
\begin{align}
\label{eq:defBmuG}
...
&= \Bigl[\frac{\nu}{\nu'}+\frac{\nu E_j + \nu Q_{\zvec\mid\rvec}}{\nu'}\Bigr]^{-\frac{\nu'+d}{2}} \\
&= \Bigl[\frac{\nu(1+E_j)}{\nu'} + \frac{\nu Q_{\zvec\mid\rvec}}{\nu'}\Bigr]^{-\frac{\nu'+d}{2}} \\
&\propto \Bigl[1 + \frac{(\frac{\nu'}{1+E_j})Q_{\zvec\mid\rvec}}{\nu'}\Bigr]^{-\frac{\nu'+d}{2}} \\
&= \Bigl[1 + \frac{(\frac{\nu'}{1+E_j})(\zvec-\muvec_j)'\Bmat(\zvec-\muvec_j)}{\nu'}\Bigr]^{-\frac{\nu'+d}{2}} \\
