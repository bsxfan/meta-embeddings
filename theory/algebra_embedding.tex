...
Let us return to the intractable MCL objective of section~\ref{sec:MCL} and play around with the composite score idea to find a tractable alternative. If MCL is applied to a small data-set, let's say never more than 8 recordings, then MCL becomes manageable---the 8-th Bell number is 4140. Can we combine MCL applied to small subsets of the data, such that it forms a proper composite score? 
