...
\noindent \textbf{In summary:} In all these simple cases, the likelihood-ratios are most compactly represented as \emph{inner products between normalized meta-embeddings}. 
