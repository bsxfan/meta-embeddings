...
Finally, we can close the loop by expressing the LR formulas of chapter~\ref{chap:fp} by using the scalar, elementwise and inner product operations of our meta-embedding space.\\ 
...
\noindent Finally, for the most general case of~\eqref{eq:generalLR}, we can rewrite\\  
