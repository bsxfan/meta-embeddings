...
Let us examine pooling in more detail. Consider pooling red and blue to give magenta:
$$
\begin{tikzpicture}[xscale=1,yscale=1]
%\draw[rotate around ={   0:(   0,   0)},black, dashed] (   0,   0) ellipse [x radius=   1, y radius=   1];
...
\end{tikzpicture}
$$
This result is perhaps counter-intuitive: 
\begin{itemize}
...
\end{itemize}
Nevertheless, we have followed the theory and the magenta result is correct. One reason why our intuition has a hard time to accept this result is because pooling is conditioned on the assumption that the speakers are the same, yet $\LRT{blue}{red}\ll 1$ gives strong support to the hypothesis that blue and red are in fact different speakers.
