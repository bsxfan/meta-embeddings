function [A,B,k,n] = getPosteriorNatParams(stats_or_ivectors,N,T,TT)
...
%   B: (k^2)-by-n, vectorized data dependent term of posterior precision matrices 
    ...
    [m,n] = size(N);  %m components, n segments
    ...
    B = TT*N; % k^2-by-n, data-dependent posterior precision terms
